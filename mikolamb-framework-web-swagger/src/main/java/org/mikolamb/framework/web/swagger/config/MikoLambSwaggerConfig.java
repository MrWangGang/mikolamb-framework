...
import static org.mikolamb.framework.common.enums.MikoLambExceptionEnum.E000000000;
import static org.mikolamb.framework.common.enums.MikoLambExceptionEnum.ES00000000;
 ...
 **/
public  class MikoLambSwaggerConfig extends SwaggerResponseMessageReader implements WebFluxConfigurer {

    private final TypeNameExtractor typeNameExtractor;
    private final TypeResolver typeResolver;

    public MikoLambSwaggerConfig(TypeNameExtractor typeNameExtractor, TypeResolver typeResolver) {
    ...
    private String formJson(MikoLambExceptionEnum mikoLambExceptionEnum){
        MikoLambResponseTemplete mikoLambResponseTemplete = new MikoLambResponseTemplete();
        mikoLambResponseTemplete.setServiceCode(mikoLambExceptionEnum.getCode());
        mikoLambResponseTemplete.setServiceMessage(mikoLambExceptionEnum.getMessage());

        return JsonUtil.objToString(mikoLambResponseTemplete);
    }
}
